...
- If ROCm routed-MoE or MXFP4 decode changed, run
  `make HIPCC=/opt/rocm-therock/bin/hipcc test-mxfp4-rocm` and require PASS for
  resident token counts plus streaming cold and warm paths.
